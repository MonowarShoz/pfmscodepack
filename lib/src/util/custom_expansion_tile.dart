...
class _CustomExpansionTileState extends State<CustomExpansionTile> with SingleTickerProviderStateMixin {
      ...
      child: Column(
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: ListTile(
              onTap: _handleTap,
              contentPadding: widget.tilePadding ?? CustomExpansionTileTheme.tilePadding,
          ...
          ClipRect(
            child: Align(
              alignment: widget.expandedAlignment ?? CustomExpansionTileTheme.expandedAlignment ?? Alignment.center,
  ...
  void didChangeDependencies() {
    ...
    _headerColorTween
      ..begin = widget.collapsedTextColor ?? CustomExpansionTileTheme.collapsedTextColor ?? theme.textTheme.subtitle1!.color
      ..end = widget.textColor ?? CustomExpansionTileTheme.textColor ?? colorScheme.primary;
    _iconColorTween
      ..begin = widget.collapsedIconColor ?? CustomExpansionTileTheme.collapsedIconColor ?? theme.unselectedWidgetColor
      ..end = widget.iconColor ?? CustomExpansionTileTheme.iconColor ?? colorScheme.primary;
